...
args = Namespace(data='processed',  activation_dropout=0.1, max_source_positions=1024, encoder_layers=6, dropout=0.1, encoder_embed_dim=512, decoder_embed_dim=512, decoder_output_dim=512, decoder_layerdrop=0, encoder_normalize_before=False, decoder_normalize_before=False, share_decoder_input_output_embed=True, max_target_positions=1024, cross_self_attention=False, decoder_ffn_embed_dim=2048,  encoder_embed_path=None, share_all_embeddings=False,encoder_layerdrop=0,encoder_attention_heads=8, attention_dropout=0.1,encoder_ffn_embed_dim=2048, decoder_layers=6,decoder_attention_heads=8, langs = 'lyric,melody', source_lang=None,source_langs='lyric,melody', target_lang=None, target_langs='lyric,melody', valid_lang_pairs='lyric-lyric,melody-melody', mt_steps= 'lyric-melody,melody-lyric', mass_steps='lyric-lyric,melody-melody', word_mask_keep_rand='0.8,0.1,0.1', word_mask=0.25, ) 
